...
const KanjiResultScreen = () => {
  ...
  const renderItem = ({ item, index }: { item: KanjiItem; index: number }) => {
      ...
      <TouchableOpacity
        ...
        onPress={() =>
          navigation.reset({
            index: 1,
            routes: [
              { name: 'SelectKanjiTest' },
              { name: 'ChooseWordCountKanjiScreen', params: { level } },
            ],
          })
        }
      >
...
export default KanjiResultScreen
